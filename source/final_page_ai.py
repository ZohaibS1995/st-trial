...
def final_page_a():
    ...
    dict_ai_only_confidence_level = {str(key): str(val) for key, val in zip(st.session_state.image_names, st.session_state.ai_only_confidence_level.values())}
    doc_ref = st.session_state["db"].collection(st.session_state["name_user"]).document("ai_only_confidence_level")
    doc_ref.set(dict_ai_only_confidence_level)
    ...
    doc_ref = st.session_state["db"].collection(st.session_state["name_user"]).document("ai_only_trial_time")
